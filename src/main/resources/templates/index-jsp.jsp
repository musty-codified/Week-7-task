...
<%@ page import="com.facebookclone.customExceptions.FailureException" %>
<%@ page import="java.sql.SQLException" %>
<%@ page import="java.time.LocalDate" %>
<%@ page import="java.util.*" %>
<%@ page import="java.text.SimpleDateFormat" %>
<%@ page import="com.facebookclone.dao.*" %>
<%@ page import="com.facebookclone.models.*" %>
...
<%
    if (request.getSession().getAttribute("status") == null || request.getSession().getAttribute("status") == "failure") {
...
<div class="header">
    ...
    <div class="header__middle">
        ...
        <div class="header__option active">
            <p>You're welcome <%=session.getAttribute("firstName")%></p>
...
<%--        <div class="btn">--%>
            <a href="${pageContext.request.contextPath}/login.jsp;userDetails=null" class="btn--blue submit login-btn">Log Out</a>
<%--        </div>--%>
    </div>
</div>
<!-- header ends -->
...
<div class="main__body">
    <!-- sidebar starts -->
    <div class="sidebar">
        <input type="hidden" id="statusID" value="<%=request.getSession().getAttribute("userID")%>">
        <input type="hidden" id="firstNameUser" value="<%=request.getSession().getAttribute("firstName")%>">
    </div>
    <!-- sidebar ends -->
    ...
    <div class="feed">
        ...
        <%@ include file="cretate_post.jsp" %>
        <!-- Creating post template ends here-->
